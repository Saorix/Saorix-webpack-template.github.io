...
async function searchJobs(query) {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('https://api.hh.ru/vacancies', {
      params: {
        text: query,
        per_page: 10
      }
...
function displayResults(jobs) {
  ...
  jobs.forEach(job => {
    ...
    jobDiv.innerHTML = `
            ...
            <p>${job.area.name}</p>
            <a href="${job.alternate_url}" target="_blank">View Job</a>
        `;
...
/* harmony import */ var _icons_right_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../icons/right.png */ "./src/icons/right.png");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.single_item').slick({
    prevArrow: `<button type="button" class="slick-prev"><img src="${_icons_right_png__WEBPACK_IMPORTED_MODULE_4__}" alt="Previous"></button>`,
    nextArrow: `<button type="button" class="slick-next"><img src="${_icons_right_png__WEBPACK_IMPORTED_MODULE_4__}" alt="Next"></button>`,
    responsive: [{
      breakpoint: 480,
      settings: {
        dots: true,
...
"use strict";
module.exports = __webpack_require__.p + "assets/f8067476df922c27844f.png";
...
/* harmony import */ var _js_VacancyWidget_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/VacancyWidget.js */ "./src/js/VacancyWidget.js");
/* harmony import */ var _style_style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style/style.css */ "./src/style/style.css");
/* harmony import */ var _style_slick_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style/slick.css */ "./src/style/slick.css");
// // jquery //
